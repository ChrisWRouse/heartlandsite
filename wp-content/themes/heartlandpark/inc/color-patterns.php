 ...
 */
function heartlandpark_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Heartland_Park default saturation level.
	 *
	 * @since Heartland_Park 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'heartlandpark_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.heartlandpark-front-page) .entry-title,
...
.colors-custom .heartlandpark-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.heartlandpark-front-page .panel-content .recent-posts article,
...
.colors-custom.heartlandpark-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Heartland_Park custom colors CSS.
	 *
	 * @since Heartland_Park 1.0
	 *
	 ...
	 */
	return apply_filters( 'heartlandpark_custom_colors_css', $css, $hue, $saturation );
}
